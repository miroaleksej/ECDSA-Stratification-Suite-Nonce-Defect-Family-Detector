...
[cite_start]**Research Classification:** Applied Cryptography / Toric Geometry [cite: 266]

---

## 1. Executive Summary

[cite_start]This study recontextualizes **ECDSA signatures** over the **secp256k1** curve not as isolated data points, but as **phase corpora** where nonce generation defects manifest as structured **"defect-families"**[cite: 258, 284]. 

* [cite_start]**Object of Study:** Corpora of ECDSA signatures and their corresponding phase coordinates[cite: 298]. 
* [cite_start]**Core Proven Statement:** Demonstrated 100% success (58/58) in the transfer of a defect-family from a real-world donor to a panel of 29 real address targets via an address-indexed reconstructive model[cite: 264, 411, 417].
* [cite_start]**Integrity & Safety:** An automated **Publication Safety Audit** identified 498 artifacts (30 critical) to be redacted, ensuring research does not facilitate immediate exploitation[cite: 265, 426, 429].
...
[cite_start]All scalar operations are defined within the finite field $\mathbb{Z}_n$, where $n$ is the order of the subgroup generated by the base point $G$[cite: 306].

* [cite_start]**Key Generation:** $Q = d \cdot G$, where $d \in [1, n-1]$ is the private key[cite: 306, 308].
* [cite_start]**Signature Generation:** For a message hash $z$ and a unique secret nonce $k$[cite: 306, 310]:
  1. [cite_start]$R = k \cdot G = (x_R, y_R)$ [cite: 306, 310]
  2. [cite_start]$r = x_R \pmod n$ [cite: 306, 311]
  3. [cite_start]$s = k^{-1}(z + r \cdot d) \pmod n$ [cite: 306, 312]
...
**Ethics & Disclosure:** This project adheres to **Responsible Disclosure** standards. [cite_start]Operational exploit sequences are redacted from this documentation to prioritize infrastructure security[cite: 253, 465].
